...
from A_utils.torch_utils import recomposition_c170
...
model.load_state_dict(torch.load(f'D_{args.model}model/saved_models/model_1.pth'))

std_data = np.load('A_utils/standardization/std_1.npz')
