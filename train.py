...
from A_utils.torch_utils import MusicDataSet, ReduceLR, EarlyStopping, fix_seed, seed_worker, format_time
...
save_dir = f'D_{args.model}model/{datetime.date.today()}'
...
std_path = f'A_utils/standardization/std_{args.index}.npz'

if not os.path.exists(std_path):
    if not os.path.exists('A_utils/standardization'):
        os.makedirs('A_utils/standardization')
